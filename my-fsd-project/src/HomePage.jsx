    ...
    <div>
      ...
      <div id="main-content2">
        <div className="navbartabs">
          ...
          <button className="tablink" onClick={handleEmployeeRegistration}>
            Employee Registration
          </button>
          <button className="tablink" onClick={handleLogin}>
            Login
          </button>
        </div>
        ...
        <div className="homecontent">
          ...
          <p>
            ...
            access short-term job opportunities, the website will help improve
            their livelihood. This is particularly beneficial for those whose
            earnings are inconsistent and rely heavily on daily job
            availability.
          </p>
        </div>
